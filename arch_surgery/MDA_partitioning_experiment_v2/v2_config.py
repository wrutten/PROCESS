...
#: Phase B arms (plan §4).  Values are the driver switches each arm sets ON
#: TOP of the a26 spec/writeset/tau baseline; None marks an arm whose driver
#: capability does not exist yet (guarded refusal, never a silent skip).
#: A1 keeps A0's upstream node order: A0 -> A1 must vary the lift and nothing
#: else (the resequencing belongs to the partition step, A1 -> A2).
PHASE_B_ARMS = ("R", "A0", "A1", "A2")
