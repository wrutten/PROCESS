...
**Numbering** — next free: **A20**, **D12**, **I-11**. Numbers are never reused.
...
1c. **Should A13 (feed-forward hoist) be revived?** The only positive-return intervention that is
   also *separable* — 4.6–8.2 % at `k = 0`, no new design variables, no dimension penalty. A19
   confirms the lift, by contrast, buys nothing without the partition. **User decision.**
1d. **Is the 10–25 % band enough to revive A4/A5?** A19 moved the partition's contribution into
